/*
Declaracion de clase Database para hacer functional testing

Contiene las funciones userExists, getPassword y addUser para hacer las pruebas funcionales
*/
...
class Database {
    public:
        ...
        // Función virtual para agregar un usuario (requiere username y contraseña)
