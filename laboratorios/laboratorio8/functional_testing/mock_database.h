/*
Archivo que contiene la defición de los mock methods para la clase Database

Los mock methods corresponden a simulaciones que imitan el comportamiento de objetos reales en pruebas de software
*/
