/*
Archivo que contiene las pruebas que se van a aplicar sobre la base de datos
...
// g++ -std=c++17 -I/usr/local/include/gtest -I/usr/local/include/gmock -L/usr/local/lib/ -lgtest -lgtest_main test_authentication.cpp -o functional.exe -pthread -lgmock
